...
namespace Hierarchy2
{
    ...
    internal class HierarchySettings : ScriptableObject
    {
        ...
        public ComponentDisplayMode componentDisplayMode = ComponentDisplayMode.ScriptOnly;
        public string[] components = new string[] {"Transform", "RectTransform"};
        [HideInInspector] public int componentLimited = 0;
        [Range(12, 16)] public int componentSize = 14;
        ...
        public ContentDisplay contentDisplay = ContentDisplay.NotScript | ContentDisplay.Component | ContentDisplay.Tag | ContentDisplay.Layer;
